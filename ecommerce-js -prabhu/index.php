Bike Rental system - Prabhu
PG Management - Mahesh
Hotel Management - Karthik
                ...
                <div class="item-card">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="product_show.php?product_id=<?php echo $item['product_id']; ?>" class="btn btn-primary">view details</a>
                        </div>
                    </div>
                </div>
            </div>

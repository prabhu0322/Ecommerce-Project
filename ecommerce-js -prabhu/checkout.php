...
$total_converted_to_paisa = $total*100;
...
<body>
    ...
    <div class="container">
        ...
        <form id="order-form" action="order_process.php" method="post">
            ...
            <input type="hidden" name="txn_no" value="<?php echo $txn_no; ?>" >
            <div class="row">
                <div class="col-md-4">
        ...
        <script>
            ...
            var options = {
                ...
                "amount": <?php echo $total_converted_to_paisa; ?>, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
                "currency": "INR",
                "name": "ABC Limited",

...
<body>
    ...
    <div class="create-form">
        <form onsubmit="save_form( event, this )" action="routes.php?route=createProduct" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="product_name" class="form-control" id="formGroupExampleInput"
                    ...
                    value="<?php echo ( !empty( $form['product_name'] ) )? $form['product_name'] : ''; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="price" class="form-control" id="formGroupExampleInput"
                    ...
                    value="<?php echo ( !empty( $form['price'] ) )? $form['price'] : ''; ?>">
            </div>
            <div class="form-group">
                ...
                <textarea class="form-control" name="product_description" id="exampleFormControlTextarea1"
                    ...
                    rows="3"> <?php echo ( !empty( $form['product_description'] ) )? $form['product_description'] : ''; ?> </textarea>
            </div>
            <div class="form-group">
    ...
    <hr>
            ...
            <div class="sub-btn">
                <button type="submit" class="btn btn-light border border-dark" id="sbt-btn">Add</button>
            </div>
